...
public class RoadrunnerAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab1 = drive.actionBuilder(initialPose)
                ...
                .splineToSplineHeading(new Pose2d(17, -25.99, Math.toRadians(-80)), Math.toRadians(-125))                .waitSeconds(2.5)
                .setTangent(Math.toRadians(50))
                .splineToSplineHeading(new Pose2d(20.85, -10, Math.toRadians(45)), Math.toRadians(50))                .waitSeconds(2.5)
