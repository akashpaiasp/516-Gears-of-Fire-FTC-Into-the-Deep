...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(0, 0, Math.toRadians(0)))
                ...
                .splineToSplineHeading(new Pose2d(15.14, -25.99, Math.toRadians(-80)), Math.toRadians(-100))
                                .waitSeconds(2.5)
                        .setTangent(Math.toRadians(50))
                .splineToSplineHeading(new Pose2d(23.5, -9, Math.toRadians(45)), Math.toRadians(50))
                .waitSeconds(2.5)
                        .setTangent(Math.toRadians(100))
                .splineToSplineHeading(new Pose2d(25.62, -25, Math.toRadians(-93)), Math.toRadians(100))
                        .waitSeconds(1)
                .setTangent(Math.toRadians(-180))
                .splineToSplineHeading(new Pose2d(23.5, -9, Math.toRadians(45)), Math.toRadians(0))
                                .waitSeconds(2.5)
                        .setTangent(Math.toRadians(75))
                .splineToSplineHeading(new Pose2d(25.62, -15, Math.toRadians(-63)), Math.toRadians(75))
                .waitSeconds(1)
